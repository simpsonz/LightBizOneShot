...
namespace BizOneShot.Light.Dao.DareConfiguration
{
    ...
    internal partial class SHUSER_SboFinancialIndexTConfiguration : EntityTypeConfiguration<SHUSER_SboFinancialIndexT>
    {
        ...
        public SHUSER_SboFinancialIndexTConfiguration(string schema)
        {
            ...
            Property(x => x.ReserchAmt)
                .HasColumnName("RESERCH_AMT")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.CurrentSale)
                .HasColumnName("CURRENT_SALE")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.PrevSale)
                .HasColumnName("PREV_SALE")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.CurrentEarning)
                .HasColumnName("CURRENT_EARNING")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.PrevEarning)
                .HasColumnName("PREV_EARNING")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.OperatingEarning)
                .HasColumnName("OPERATING_EARNING")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.TotalCapital)
                .HasColumnName("TOTAL_CAPITAL")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.CurrentAsset)
                .HasColumnName("CURRENT_ASSET")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.InventoryAsset)
                .HasColumnName("INVENTORY_ASSET")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.CurrentLiability)
                .HasColumnName("CURRENT_LIABILITY")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.TotalLiability)
                .HasColumnName("TOTAL_LIABILITY")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.TotalAsset)
                .HasColumnName("TOTAL_ASSET")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.NonOperEar)
                .HasColumnName("NON_OPER_EAR")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.InterstCost)
                .HasColumnName("INTERST_COST")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.Salescredit)
                .HasColumnName("SALES CREDIT")
                .IsOptional()
                .HasColumnType("decimal")
                .HasPrecision(17, 4);
            Property(x => x.ValueAdded)
