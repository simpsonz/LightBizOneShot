...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class ScQaConfiguration : EntityTypeConfiguration<ScQa>
    {
        ...
        public ScQaConfiguration(string schema)
        {
            ...
            Property(x => x.UsrQaSn)
                .HasColumnName("USR_QA_SN")
                .IsRequired()
                .HasColumnType("int")
            ...
            // Foreign keys
            HasOptional(a => a.ScUsr_AnswerId).WithMany(b => b.ScQas_AnswerId).HasForeignKey(c => c.AnswerId);
                // FK_SC_USR_TO_SC_QA2
            HasOptional(a => a.ScUsr_QuestionId).WithMany(b => b.ScQas_QuestionId).HasForeignKey(c => c.QuestionId);
                // FK_SC_USR_TO_SC_QA
            InitializePartial();
        }
