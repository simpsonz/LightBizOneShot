...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class ScBizWorkConfiguration : EntityTypeConfiguration<ScBizWork>
    {
        ...
        public ScBizWorkConfiguration(string schema)
        {
            ...
            Property(x => x.BizWorkNm)
                .HasColumnName("BIZ_WORK_NM")
                .IsOptional()
                .HasColumnType("nvarchar")
                .HasMaxLength(50);
            Property(x => x.BizWorkSummary)
                .HasColumnName("BIZ_WORK_SUMMARY")
                .IsOptional()
                .HasColumnType("nvarchar")
                .HasMaxLength(1000);
            ...
            // Foreign keys
            HasRequired(a => a.ScCompInfo).WithMany(b => b.ScBizWorks).HasForeignKey(c => c.MngCompSn);
                // FK_SC_COMP_INFO_TO_SC_BIZ_WORK
            HasRequired(a => a.ScUsr).WithMany(b => b.ScBizWorks).HasForeignKey(c => c.ExecutorId);
                // FK_SC_USR_TO_SC_BIZ_WORK
            InitializePartial();
        }
