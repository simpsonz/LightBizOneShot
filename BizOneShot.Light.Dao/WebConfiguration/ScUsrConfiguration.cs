    ...
    internal partial class ScUsrConfiguration : EntityTypeConfiguration<ScUsr>
    {
        ...
        public ScUsrConfiguration(string schema)
        {
            ...
            Property(x => x.UsrType)
                ...
                .HasColumnType("char")
                .HasMaxLength(1);
            Property(x => x.UsrTypeDetail)
                .HasColumnName("USR_TYPE_DETAIL")
                .IsOptional()
                .IsFixedLength()
                .IsUnicode(false)
                .HasColumnType("char")
            ...
            // Foreign keys
            HasOptional(a => a.SyDareDbInfo).WithMany(b => b.ScUsrs).HasForeignKey(c => c.DbType);
                // FK_SY_DARE_DB_INFO_TO_SC_USR
            HasRequired(a => a.ScCompInfo).WithMany(b => b.ScUsrs).HasForeignKey(c => c.CompSn);
                // FK_SC_COMP_INFO_TO_SC_USR
            InitializePartial();
        }
