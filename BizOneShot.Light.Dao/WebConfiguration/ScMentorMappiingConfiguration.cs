...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class ScMentorMappiingConfiguration : EntityTypeConfiguration<ScMentorMappiing>
    {
        ...
        public ScMentorMappiingConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasOptional(a => a.ScCompInfo).WithMany(b => b.ScMentorMappiings).HasForeignKey(c => c.MngCompSn);
                // FK_SC_COMP_INFO_TO_SC_MENTOR_MAPPIING
            HasRequired(a => a.ScBizWork).WithMany(b => b.ScMentorMappiings).HasForeignKey(c => c.BizWorkSn);
                // FK_SC_BIZ_WORK_TO_SC_MENTOR_MAPPIING
            HasRequired(a => a.ScUsr).WithMany(b => b.ScMentorMappiings).HasForeignKey(c => c.MentorId);
                // FK_SC_USR_TO_SC_MENTOR_MAPPIING
            InitializePartial();
        }
