...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class ScMentoringFileInfoConfiguration : EntityTypeConfiguration<ScMentoringFileInfo>
    {
        ...
        public ScMentoringFileInfoConfiguration(string schema)
        {
            ...
            // Foreign keys
            HasRequired(a => a.ScFileInfo).WithOptional(b => b.ScMentoringFileInfo);
                // FK_SC_FILE_INFO_TO_SC_MENTORING_FILE_INFO
            HasRequired(a => a.ScMentoringReport).WithMany(b => b.ScMentoringFileInfoes).HasForeignKey(c => c.ReportSn);
                // FK_SC_MENTORING_REPORT_TO_SC_MENTORING_FILE_INFO
            InitializePartial();
        }
