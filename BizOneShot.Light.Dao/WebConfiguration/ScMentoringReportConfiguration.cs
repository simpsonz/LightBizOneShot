...
namespace BizOneShot.Light.Dao.WebConfiguration
{
    ...
    internal partial class ScMentoringReportConfiguration : EntityTypeConfiguration<ScMentoringReport>
    {
        ...
        public ScMentoringReportConfiguration(string schema)
        {
            ...
            Property(x => x.ReportSn)
                .HasColumnName("REPORT_SN")
                .IsRequired()
                .HasColumnType("int")
            ...
            Property(x => x.MentoringStHr)
                .HasColumnName("MENTORING_ST_HR")
                .IsOptional()
                .IsUnicode(false)
                .HasColumnType("varchar")
                .HasMaxLength(5);
            Property(x => x.MentoringEdHr)
                .HasColumnName("MENTORING_ED_HR")
                .IsOptional()
                .IsUnicode(false)
                .HasColumnType("varchar")
                .HasMaxLength(5);
            Property(x => x.MentoringPlace)
                .HasColumnName("MENTORING_PLACE")
                .IsOptional()
                .HasColumnType("nvarchar")
                .HasMaxLength(200);
            Property(x => x.Attendee).HasColumnName("ATTENDEE").IsOptional().HasColumnType("nvarchar").HasMaxLength(200);
            Property(x => x.MentorAreaCd)
                .HasColumnName("MENTOR_AREA_CD")
                .IsOptional()
                .IsFixedLength()
                .IsUnicode(false)
                .HasColumnType("char")
                .HasMaxLength(1);
            Property(x => x.MentoringSubject)
                .HasColumnName("MENTORING_SUBJECT")
                .IsOptional()
                .HasColumnType("nvarchar")
                .HasMaxLength(1000);
            Property(x => x.MentoringContents)
                .HasColumnName("MENTORING_CONTENTS")
                .IsOptional()
                .HasColumnType("nvarchar")
                .HasMaxLength(2000);
            ...
            // Foreign keys
            HasOptional(a => a.ScCompInfo).WithMany(b => b.ScMentoringReports).HasForeignKey(c => c.CompSn);
                // FK_SC_COMP_INFO_TO_SC_MENTORING_REPORT
            HasOptional(a => a.ScUsr).WithMany(b => b.ScMentoringReports).HasForeignKey(c => c.MentorId);
                // FK_SC_USR_TO_SC_MENTORING_REPORT
            HasRequired(a => a.ScBizWork).WithMany(b => b.ScMentoringReports).HasForeignKey(c => c.BizWorkSn);
                // FK_SC_BIZ_WORK_TO_SC_MENTORING_REPORT
            InitializePartial();
        }
