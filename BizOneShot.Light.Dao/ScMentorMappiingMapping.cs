...
{
    // SC_MENTOR_MAPPIING
    internal partial class ScMentorMappiingMapping : EntityTypeConfiguration<ScMentorMappiing>
    {
        public ScMentorMappiingMapping()
            : this("dbo")
        {
        }
 
        public ScMentorMappiingMapping(string schema)
        {
