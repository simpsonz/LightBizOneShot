...
namespace BizOneShot.Light.Dao.Repositories
{
    ...
    {
        Task<IPagedList<ScQa>> GetpagedListQAsAsync(int page, int pageSize, string questionId, string expertType, DateTime? startDate = null, DateTime? endDate = null);
    ...
    public class ScQaRepository : RepositoryBase<ScQa>, IScQaRepository
    {
        ...
        public async Task<IPagedList<ScQa>> GetpagedListQAsAsync(int page, int pageSize, string questionId, string expertType, DateTime? startDate = null, DateTime? endDate = null)
        {
            return await this.DbContext.ScQas
                .Include("ScUsr_QuestionId")
                .Include("ScUsr_QuestionId.ScCompInfo")
                .Include("ScUsr_AnswerId")
                .Include("ScUsr_AnswerId.ScCompInfo")
                .Where(sq => sq.QuestionId == questionId && sq.ScUsr_AnswerId.UsrType == "P" && sq.ScUsr_AnswerId.UsrTypeDetail == expertType)
