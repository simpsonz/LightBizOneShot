...
namespace BizOneShot.Light.Dao.Repositories
{
    ...
    public class ScMentoringTrFileInfoRepository : RepositoryBase<ScMentoringTrFileInfo>, IScMentoringTrFileInfoRepository
    {
        public ScMentoringTrFileInfoRepository(IDbFactory dbFactory) : base(dbFactory) { }

        public async Task<IList<ScMentoringTrFileInfo>> GetMentoringTrFileInfo(Expression<Func<ScMentoringTrFileInfo, bool>> where)
        {
            return await this.DbContext.ScMentoringTrFileInfoes
