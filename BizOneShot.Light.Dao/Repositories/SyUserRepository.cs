...
namespace BizOneShot.Light.Dao.Repositories
{
    ...
    public class SyUserRepository : DareRepositoryBase<SHUSER_SyUser>, ISyUserRepository
    {
        ...
        public int Insert(SHUSER_SyUser syUser)
        {
            ...
            string commandString = string.Format("INSERT INTO SHUSER.SY_USER (ID_USER, MEMB_BUSNPERS_NO, NM_USER, PWD, USR_GBN, USER_STATUS, INSERT_ID, INSERT_DT, WEB_USR_GBN) VALUES('{0}','{1}','{2}',PWDENCRYPT('{3}'),'{4}','{5}', '{6}', CONVERT(VARCHAR, GETDATE(), 112), '{7}')",
