...
namespace BizOneShot.Light.Dao.Repositories
{
    ...
    public class ScMentoringFileInfoRepository : RepositoryBase<ScMentoringFileInfo>, IScMentoringFileInfoRepository
    {
        ...
        public async Task<IList<ScMentoringFileInfo>> GetMentoringFileInfo(Expression<Func<ScMentoringFileInfo, bool>> where)
        {
            return await this.DbContext.ScMentoringFileInfoes
