...
namespace BizOneShot.Light.Models.WebModels
{
    ...
    public class ScFileInfo
    {
        ...
        // Reverse navigation
        public virtual ICollection<ScUsrResume> ScUsrResumes { get; set; }
        // SC_USR_RESUME.FK_SC_FILE_INFO_TO_SC_USR_RESUME
        public virtual ScFormFile ScFormFile { get; set; } // SC_FORM_FILE.FK_SC_FILE_INFO_TO_SC_FORM_FILE
        public virtual ScMentoringFileInfo ScMentoringFileInfo { get; set; }
        // SC_MENTORING_FILE_INFO.FK_SC_FILE_INFO_TO_SC_MENTORING_FILE_INFO
        public virtual ScMentoringTrFileInfo ScMentoringTrFileInfo { get; set; }
        // SC_MENTORING_TR_FILE_INFO.FK_SC_FILE_INFO_TO_SC_MENTORING_TR_FILE_INFO
