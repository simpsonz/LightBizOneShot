...
namespace BizOneShot.Light.Models.WebModels
{
    ...
    public class QuesMaster
    {
        ...
        public virtual QuesCompExtention QuesCompExtention { get; set; }
        // QUES_COMP_EXTENTION.FK_QUES_MASTER_TO_QUES_PRESIDENT_INFO
        public virtual QuesCompHistory QuesCompHistory { get; set; }
        // QUES_COMP_HISTORY.FK_QUES_MASTER_TO_QUES_COMP_HISTORY
