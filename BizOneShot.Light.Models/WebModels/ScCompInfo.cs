...
namespace BizOneShot.Light.Models.WebModels
{
    ...
    public class ScCompInfo
    {
        ...
        // STATUS. 상태  N: 정상회원(Normal)  P: 승인대기(Pending) - 사용안함  C: 거절됨(Canceled) - 사용안함  R: 탈퇴 요청(Retired)  D: 탈퇴 완료(Deleted)
        ...
        public virtual ICollection<ScMentoringReport> ScMentoringReports { get; set; }
        // SC_MENTORING_REPORT.FK_SC_COMP_INFO_TO_SC_MENTORING_REPORT
        public virtual ICollection<ScMentoringTotalReport> ScMentoringTotalReports { get; set; }
        // SC_MENTORING_TOTAL_REPORT.FK_SC_COMP_INFO_TO_MENTORING_TOTAL_REPORT
        public virtual ICollection<ScMentorMappiing> ScMentorMappiings { get; set; }
        // SC_MENTOR_MAPPIING.FK_SC_COMP_INFO_TO_SC_MENTOR_MAPPIING
