...
namespace BizOneShot.Light.Models.WebModels
{
    ...
    public class ScMentoringTotalReport
    {
        ...
        // Reverse navigation
        public virtual ICollection<ScMentoringTrFileInfo> ScMentoringTrFileInfoes { get; set; }
        // SC_MENTORING_TR_FILE_INFO.FK_MENTORING_TOTAL_REPORT_TO_SC_MENTORING_TR_FILE_INFO
